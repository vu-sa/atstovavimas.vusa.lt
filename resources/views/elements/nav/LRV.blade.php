<li class="nav-item dropdown dropend">
  <a class="nav-link dropdown-toggle" href="#vyriausybe" id="navbarDarkDropdownMenuLink" role="button"
  ...
  <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
    ...
    <div class="dropdown-divider"></div>  
      ...
      <li><a class="dropdown-item" href="#lrv-komitetai-komisijos">Vyriausybės komitetai ir komisijos</a></li>
      <div class="dropdown-divider"></div>
      <li><a class="dropdown-item" href="#lrv-ministerijos">Lietuvos Respublikos ministerijos</a></li>
      <li><a class="dropdown-item" href="#lrv-pavaldzios-istaigos">Pavaldžios įstaigos</a></li>
  </ul>
</li>
