<section id="smsm">
    <h2>Švietimo, mokslo ir sporto ministerija</h2>
    <section title="Švietimo, mokslo ir sporto ministerijos schema">
        <h3>LR Švietimo, mokslo ir sporto ministerijos ir susijusių struktūrų schema</h3>
        @include('graphs.SMSM')

        <p>Vyriausybės ir su ja susijusių struktūrų schemoje nagrinėjome aukštojo mokslo politikos įgyvendinimą.</p>
        <p>Švietimo klausimai yra susiję su Švietimo, mokslo ir sporto ministerija (ŠMSM) ar jai pavaldžiomis
            institucijomis, todėl inicijuojant įstatymo ar nutarimo pakeitimą, svarbu įsigilinti, koks yra ministerijos
            darbo organizavimas, kokiuose departamentuose ir skyriuose gali atsidurti konkretūs klausimai bei kokie
            departamentai ir / ar skyriai gali padėti klausimo svarstymo eigoje. </p>
        <p>Atskirų klausimų svarstyme ŠMSM ministras ar ministerijai pavaldžios institucijos turi teisę sukurti
            komisijas arba darbo grupes. Poreikį tam tikroms darbo grupėms gali išreikšti ir studentų atstovai. Dažnu
            atveju į šių klausimų svarstymą gali būti įtraukos ir ŠMSM pavaldžios institucijos, todėl reikia žinoti ir
            jų kompetencijas ir kuruojamus klausimus.</p>
        <p>Schemoje apibendrintai pavaizduoti visi departamentai, tačiau mums, kaip studentų atstovams, yra ypač svarbūs
            keli departamentų skyriai, nes jie daugiausia prisideda prie aukštojo mokslo politikos įgyvendinimo: </p>

    </section>


    <section id="smt-studiju-skyrius">
        <h3>Studijų, mokslo ir technologijų departamento Studijų skyrius</h3>
        <p>Šis skyrius analizuoja aukštąjį mokslą reglamentuojančius įstatymus, Vyriausybės nutarimus, teikia išvadas
            aukštojo mokslo sistemos vystymo, aukštųjų mokyklų steigimo ar pertvarkymo, aukštųjų mokyklų veiklos ir
            studijų kokybės reikalavimų, studentų priėmimo, studijų vietų skaičiaus bei studijų proceso organizavimo ir
            kitais klausimais. Be to, Studijų skyrius dalyvauja rengiant studijų krypčių aprašus, rengiant bei
            įgyvendinant kvalifikacijų sistemą, bendradarbiauja su valstybės, ekspertinėmis, aukštųjų mokyklų veiklą
            koordinuojančiomis institucijomis, studentų atstovais.</p>
        <p>
            Išsamiau galite susipažinti <a target="_blank" href="https://www.smm.lt/uploads/contacts/docs/35_c84ac34e8fd28c86e657ac5d7d7a7b61.pdf">čia</a>
        </p>
    </section>
    <section id="ekonomikos-departamento-ms-ekonomikos-skyrius">
        <h3>Ekonomikos departamento mokslo ir studijų ekonomikos skyrius </h3>
        <p>Šis skyrius dalyvauja formuojant bei įgyvendinant mokslo ir studijų sistemos finansavimo politiką ir siekia,
            kad būtų racionaliai paskirstomi ir naudojami mokslui bei studijoms skirti valstybės biudžeto finansai.
            Mokslo ir studijų ekonomikos skyrius dalyvauja mokslo bei studijų finansavimą liečiančių įstatymų ar
            nutarimų rengime.</p>
        <p>
            Išsamiau galite susipažinti <a target="_blank" href="https://www.smm.lt/uploads/contacts/docs/43_0fb5f778a2fa662814f06d143800b9a7.pdf">čia</a>
        </p>
    </section>
    <section id="mvs-neformalaus-svietimo-skyrius">
        <h3>Mokymosi visą gyvenimą departamento neformalaus švietimo skyrius</h3>

        <p>Vienas iš skyriaus uždavinių yra dalyvauti formuojant ir įgyvendinant valstybinę mokymosi visą gyvenimą ir
            suaugusiųjų švietimo politiką. Vykdydamas paskirtas užduotis, šis skyrius rengia siūlymus ir teisės aktų
            projektus dėl mokymosi visą gyvenimą sistemos, kvalifikacijų sandaros ir neformaliuoju būdu įgytų
            kompetencijų pripažinimo sistemos tobulinimo bei plėtros, koordinuoja kvalifikacijų sandaros ir
            neformaliuoju būdu įgytų kompetencijų pripažinimą, koordinuoja neformaliojo suaugusiųjų švietimo ir tęstinio
            mokymosi įstatymo įgyvendinimą.</p>

        <p>
            Išsamiau galite susipažinti <a target="_blank" href="https://www.smm.lt/uploads/contacts/docs/125_02e6278ec24278c874c9dfeb650070d7.pdf">čia</a>
        </p>

        <p>Šios įstaigos veikla yra planuojama – yra tvirtinami strateginiai, metiniai veiklos planai bei kiti planavimo
            dokumentai, kurie yra viešai prieinami ministerijos interneto svetainėje.</p>
    </section>

    <section id="smsm-ministras">
        <h3>Švietimo, mokslo ir sporto ministras</h3>

        <p>Švietimo, mokslo ir sporto ministras – remiantis LR Vyriausybės įstatymu ir LR Vyriausybės nutarimu „Dėl
            ministrams pavedamų valdymo sričių“, ŠMSM ministras yra atsakingas už švietimo, mokslo bei sporto sritis ir
            vadovauja ministerijai, užtikrina teisės aktų įgyvendinimą, teikia Vyriausybei įstatymų ar kitų teisės aktų
            projektus, pasirašo įsakymus ir tikrina jų įgyvendinimą, rengia ir tvirtina jam pavestų valdymo sričių
            strateginį veiklos planą, koordinuoja ir kontroliuoja ŠMSM administracijos padalinių veiklą, nustato ŠMSM
            viceministrų bei kanclerio administravimo sritis ir atlieka kitas funkcijas.</p>
        <p>Išsamiau su ministrų funkcijomis galite susipažinti <a target="_blank" href="https://e-seimas.lrs.lt/portal/legalAct/lt/TAD/TAIS.5807/asr">čia</a> (26 straipsnis).</p>
        <p>Su LR Vyriausybės nutarimu „Dėl ministrams pavedamų valdymo sričių“ galite susipažinti <a
                href="https://e-seimas.lrs.lt/portal/legalAct/lt/TAD/TAIS.368484/asr">čia</a></p>
    </section>
    <section id="smsm-viceministrai">
        <h3>Švietimo, mokslo ir sporto viceministrai</h3>
        <p>Švietimo, mokslo ir sporto viceministrai – viceministrai ŠMSM ministro nustatytose veiklos srityse atlieka
            Vyriausybės įstatyme nustatytas funkcijas. Kadangi viceministrų skaičius ir funkcijos gali skirtis tarp
            kadencijų, iliustruojant 2020–2024 m. pavyzdžiu keturių viceministrų veiklos laukai buvo šie – studijų,
            mokslo ir technologijų klausimai; ikimokyklinio, priešmokyklinio ir bendrojo ugdymo klausimai; fizinio
            aktyvumo ir aukšto meistriškumo mokslo klausimai; profesinio mokymo ir orientavimo klausimai.</p>
        <p><a target="_blank" href="https://www.smm.lt/web/lt/contacts">Išsamiau su ŠMSM viceministrų funkcijomis galite susipažinti čia
                (ministerijos vadovybės skiltis)</a></p>
    </section>
    <section id="smsm-patarejai">
        <h3>Švietimo, mokslo ir sporto ministro patarėjai</h3>
        <p>Švietimo, mokslo ir sporto ministro patarėjai – padeda ministrui suformuoti politines nuostatas ir
            prioritetus, priimti sprendimus ir juos įgyvendinti. Ministras savo įgaliojimų laikotarpiu gali turėti
            visuomeninių konsultantų, kurie jo prašymu teikia jam konsultacijas, pasiūlymus, išvadas ir kitą
            informaciją.</p>
        <p><a target="_blank" href="https://www.smm.lt/web/lt/contacts">Išsamiau su ŠMSM patarėjų ir padėjėjų funkcijomis galite
                susipažinti čia (ministro patarėjų ir padėjėjų </a>skiltis.</p>
    </section>
    <section id="smsm-kancleris">
        <h3>Švietimo, mokslo ir sporto ministerijos kancleris</h3>
        <p>Kancleris – politinio (asmeninio) pasitikėjimo valstybės tarnautojas, pavaldus ministrui. Švietimo, mokslo ir
            sporto ministerijos kancleris atlieka Vyriausybės įstatyme nustatytas, kitų įstatymų, Vyriausybės nutarimų
            ir ministro pavestas funkcijas. ŠMSM kancleris vadovauja ministerijos administracijai, pagal kompetenciją
            priima potvarkius, saugo ministerijos antspaudą ir atsako už jo naudojimą.</p>
        <p><a target="_blank" href="https://www.smm.lt/web/lt/administracine-informacija/nuostatai">Išsamiau su kanclerio funkcijomis
                galite susipažinti ŠMSM nuostatuose</a></p>
    </section>

    <section id="smsm-kiti-skyriai-ir-grupes">
        <h3>Kiti skyriai ir grupės</h3>
        <p>Kiti skyriai ir grupės – užtikrina pagrindinių ŠMSM procesų įgyvendinimą. </p>
        <p><a target="_blank" href="https://www.smm.lt/web/lt/struktura-ir-kontaktai/ministerijos-struktura">Plačiau galite susipažinti
                čia</a> </p>
    </section>
    ...
    <section id="smsm-pavaldzios-institucijos">
        <h3>ŠMSM pavaldžios institucijos</h3>
    
        <section id="smsm-skvc">
            <h4>Studijų kokybės vertinimo centras</h4>
            ...
            <section id="skvc-apeliacine-komisija">
                <h5>Studijų kokybės vertinimo centro apeliacinė komisija</h5>
            ...
            <section id="studiju-vertinimo-komisija">
                <h5>Studijų vertinimo komisija</h5>
            ...
            <section id="aukstuju-mokyklu-vertinimo-komisija">
                <h5>Aukštųjų mokyklų vertinimo komisija</h5>
        ...
        <section id="smpf">
            <h4>Švietimo mainų ir paramos fondas (ŠMPF)</h4>
        ...
        <section id="smsm-vsf">
            <h4>Valstybinis studijų fondas (VSF)</h4>
        ...
        <section id="nsa">
            <h4>Nacionalinė švietimo agentūra (NŠA)</h4>
        ...
        <section id="esfa">
            <h4>Europos socialinio fondo agentūra (ESFA)</h4>
        ...
        <section id="kpmpc">
            <h4>Kvalifikacijų ir profesinio mokymo plėtros centras</h4>
            <p>
        ...
        <section id="lmnsc">
            <h4>Lietuvos mokinių neformaliojo švietimo centras</h4>
        ...
        <section>
            <h4>Lietuvos vaikų ir jaunimo centras</h4>
        ...
        <section id="melc">
            <h4>Mokslo ir enciklopedijų leidybos centras</h4>
        ...
        <section id="nvi">
            <h4>Nacionalinis vėžio institutas</h4>
    ...
    <section id="smsm-komisijos-ir-darbo-grupes">
        ...
        <p>Tam tikrais atvejais į ŠMSM formuojamas komisijas bei darbo grupes yra deleguojami studentų atstovai iš
            nacionalinių studentams atstovaujančių organizacijų (t.y. Vilniaus universiteto Studentų atstovybės ir / arba
            Lietuvos studentų sąjungos). Studentų atstovų skaičius varijuoja, tačiau jų būna arba 1 mažesnėse, arba 2
            didesnėse grupėse. Pavyzdžiui, 2018 metais sudarytoje darbo grupėje dėl Bolonijos proceso stebėsenos ir
            įgyvendinimo koordinavimo Lietuvoje mes galime pamatyti du studentų atstovus (vienas iš VU SA, kitas iš LSS) iš
            17 narių. Studentų atstovai į suformuotas darbo grupes gali būti deleguojami proaktyviai (kai studentų savivalda
            kreipiasi į ŠMSM su prašymu įtraukti atstovą) arba reaktyviai (kai ŠMSM ministras kreipiasi į studentų savivaldą
            dėl atstovo delegavimo). Be konkrečių komisijų ar darbo grupių atvejų, nacionaliniu mastu atstovaujančios
            studentų savivaldos gali palaikyti dialogą su ŠMSM ministru, teikti ministerijai savo suformuotus pasiūlymus
            švietimo politikai.</p>
        <p>Išsamiau su ŠMSM komisijomis bei darbo grupėmis galite susipažinti <a target="_blank" href="https://www.smm.lt/web/lt/komisijos-ir-darbo-grupes">čia</a></p>
    </section>
