<section id="seimas">
    ...
    <section title="Seimo schema">
        ...
        <p>Šioje schemoje pristatomi Seimo organizaciniai dariniai ir susijusių struktūrų veikla bei jų tarpusavio
            ryšiai.</p>
        <p>Kadangi Seimas yra įstatymų leidžiamoji valdžia, turime žinoti kaip organizuojamos Seimo sesijos, kaip
            atsiranda konkretūs pasiūlymai įstatymų projektams bei kaip prie to prisideda Seimo Pirmininkas, Valdyba,
        ...
        <p>Schemoje apibendrintai pavaizduoti visi komitetai ir komisijos, tačiau mums, kaip studentų atstovams, yra
            svarbiausi Švietimo ir mokslo komitetas bei Jaunimo ir sporto reikalų komisija. Todėl toliau pateikiame šių
            komitetų santraukas. </p>

    </section>

    <section id="seimas-smk">
        <h3>Švietimo ir mokslo komitetas</h3>
        <p>Švietimo ir mokslo komitetas (ŠMK) rengia ir svarsto reglamentuojančius įstatymus, nutarimus bei pasiūlymus,
    ...
    <section id="jaunimo-ir-sporto-reikalu-komisija">
        ...
        <p>Jaunimo ir sporto reikalų komisija rūpinasi valstybės jaunimo ir sporto politikos formavimu ir įgyvendinimu
            ir teikia pasiūlymus Seimui, Vyriausybei ir kitoms institucijoms dėl teisės aktų, reglamentuojančių jaunimo
    ...
    <img class="img-fluid" src="/img/main/image032.jpg">
    ...
    <section id="seimo-pirmininko-pavaduotojai">
    ...
    <section id="seniunu-sueiga">
        ...
        <p>Seime veikia Seniūnų sueiga, į kurią įeina Seimo valdybos nariai ir frakcijų atstovai, kurių skaičius
    ...
    <section id="seimo-komitetai">
        <h3>Komitetai</h3>
        <p>Seimas įstatymams nagrinėti ir kitiems klausimams spręsti sudaro komitetus. Komitetai svarbiausioms veiklos
            kryptims iš savo narių gali sudaryti pakomitečius. Komitetų darbui vadovauja jų pirmininkai. Pagrindinės
            komitetų veiklos kryptys yra teisėkūra ir parlamentinė kontrolė.</p>
        <p>Komitetai analizuoja, kaip vykdomi įstatymai ir kiti Seimo sprendimai, svarsto Seimui atskaitingų įstaigų
    ...
    <section id="seimo-komisijos">
        <h3>Komisijos</h3>
        <p>
            Seimas įstatymams nagrinėti ir kitiems klausimams spręsti sudaro komisijas. Komisijų darbui vadovauja jų
            pirmininkai. Pagrindinės komisijų veiklos kryptys yra teisėkūra ir parlamentinė kontrolė.
        </p>
        <p>
            Komitetai ir komisijos analizuoja, kaip vykdomi įstatymai ir kiti Seimo sprendimai, svarsto Seimui atskaitingų
    ...
    <section id="seimo-kanceliarija">
        <h3>Seimo kanceliarija</h3>
        <p>
            Seimo kanceliarijos žmonės atlieka įvairias užduotis, kad užtikrintų sklandų Seimo darbą ir nepertraukiamą
